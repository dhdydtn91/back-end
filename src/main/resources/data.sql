...
-- review
insert into review (id, cost_performance, one_line_comment, rating, recommendation, status, strength_comment, weakness_comment, lecture_id)
values (1,'VERY_SATISFACTION','아주 좋은 강의예여','5.0','GOOD','READY','기초부터 잘 알려줍니다.','마이크가 조금 안들려요','1');
insert into review (id, cost_performance, one_line_comment, rating, recommendation, status, strength_comment, weakness_comment, lecture_id)
values (2,'VERY_SATISFACTION','아주 좋은 강의예여','5.0','GOOD','APPROVE','기초부터 잘 알려줍니다.','마이크가 조금 안들려요','1');
insert into review (id, cost_performance, one_line_comment, rating, recommendation, status, strength_comment, weakness_comment, lecture_id)
values (3,'VERY_SATISFACTION','아주 좋은 강의예여','5.0','GOOD','APPROVE','기초부터 잘 알려줍니다.','마이크가 조금 안들려요','2');
insert into review (id, cost_performance, one_line_comment, rating, recommendation, status, strength_comment, weakness_comment, lecture_id)
values (4,'VERY_SATISFACTION','아주 좋은 강의예여','5.0','GOOD','APPROVE','기초부터 잘 알려줍니다.','마이크가 조금 안들려요','2');
insert into review (id, cost_performance, one_line_comment, rating, recommendation, status, strength_comment, weakness_comment, lecture_id)
values (5,'VERY_SATISFACTION','아주 좋은 강의예여','5.0','GOOD','APPROVE','기초부터 잘 알려줍니다.','마이크가 조금 안들려요','3');
insert into review (id, cost_performance, one_line_comment, rating, recommendation, status, strength_comment, weakness_comment, lecture_id)
values (6,'VERY_SATISFACTION','아주 좋은 강의예여','5.0','GOOD','REJECT','기초부터 잘 알려줍니다.','마이크가 조금 안들려요','4');
